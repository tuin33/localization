...
const string MyDataLeftAntenna = R"(myData - leftAntenna.txt)";
const string MyDataRightAntenna = R"(myData - rightAntenna.txt)";
const string OdometerVisionStartPoint = R"(odometer_vision_start_point.txt)";
...
int main()
{
	...
	//系统数据导入
	//RFID和机器人数据
	MyDataResult myDataResultLeft(MyDataLeftAntenna);
	MyDataResult myDataResultRight(MyDataRightAntenna);
	...
	MATFile* pM0 = matOpen("test400.mat", "r");
